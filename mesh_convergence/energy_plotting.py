...
def plot_stiff_skin_time(E1, E2, E3, E4, E5, E6, savefig=False, savepath=''):
    ...
    ax.plot(E1.time * 1e3,  E1.stiffeners / 1e3, label=E1.label)
    ax.plot(E2.time * 1e3,  E2.stiffeners / 1e3, label=E2.label)
    ax.plot(E3.time * 1e3,  E3.stiffeners / 1e3, label=E3.label)
    ax.plot(E4.time * 1e3,  E4.stiffeners / 1e3, label=E4.label)
    ax.plot(E5.time * 1e3,  E5.stiffeners / 1e3, label=E5.label)
    ax.plot(E6.time * 1e3,  E6.stiffeners / 1e3, label=E6.label)

...
DRI_mean = np.array([DRI000_mean, DRI015_mean, DRI030_mean, DRI045_mean, DRI060_mean, DRI070_mean])
frames = np.array([0.0, 0.15, 0.30, 0.45, 0.60, 0.70])

#determine mean accelerations
mean_accels_000 = ACC000.get_mean_accel(0.10)
mean_accels_015 = ACC015.get_mean_accel(0.10)
mean_accels_030 = ACC030.get_mean_accel(0.10)
mean_accels_045 = ACC045.get_mean_accel(0.10)
mean_accels_060 = ACC060.get_mean_accel(0.10)
mean_accels_070 = ACC070.get_mean_accel(0.10)
...
mean_accels_avg = np.array([mean_accels_000_avg, mean_accels_015_avg, mean_accels_030_avg, mean_accels_045_avg, mean_accels_060_avg, mean_accels_070_avg])

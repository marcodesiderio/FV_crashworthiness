...
data = [a.DRI000, a.DRI015, a.DRI030, a.DRI045, a.DRI060, a.DRI070]
ax_dri.plot(a.frames, a.DRI_mean, marker = 'o', markersize = 6, label='Average value')
ax_dri.boxplot(data, positions = [0, 0.15, 0.30, 0.45, 0.60, 0.70], widths=(bplw, bplw, bplw, bplw, bplw, bplw))
...
ax_dri.scatter(a.frames[4] * np.ones_like(a.DRI060), a.DRI060, label = 'e = 0.60', s=16)
ax_dri.scatter(a.frames[5] * np.ones_like(a.DRI070), a.DRI070, label = 'e = 0.70', s=16)
...
data = [a.mean_accels_000, a.mean_accels_015, a.mean_accels_030, a.mean_accels_045, a.mean_accels_060, a.mean_accels_070]
ax0.boxplot(data, positions = [0, 0.15, 0.30, 0.45, 0.60, 0.70], widths=(bplw, bplw, bplw, bplw, bplw, bplw))
ax0.plot(a.frames, a.mean_accels_avg, marker = 'o', markersize = 6, label = 'Average value')
ax0.scatter(a.frames[0] * np.ones_like(a.mean_accels_000), a.mean_accels_000, label = 'e = 0.0', s=16)
ax0.scatter(a.frames[1] * np.ones_like(a.mean_accels_015), a.mean_accels_015, label = 'e = 0.15', s=16)
ax0.scatter(a.frames[2] * np.ones_like(a.mean_accels_030), a.mean_accels_030, label = 'e = 0.30', s=16)
ax0.scatter(a.frames[3] * np.ones_like(a.mean_accels_045), a.mean_accels_045, label = 'e = 0.45', s=16)
ax0.scatter(a.frames[4] * np.ones_like(a.mean_accels_060), a.mean_accels_060, label = 'e = 0.60', s=16)
ax0.scatter(a.frames[5] * np.ones_like(a.mean_accels_070), a.mean_accels_070, label = 'e = 0.70', s=16)
ax0.legend()
...
ax1.plot(a.mean_accel.x, a.mean_accels_000, label = 'e = 0.0')
ax1.plot(a.mean_accel.x, a.mean_accels_015, label = 'e = 0.15')
ax1.plot(a.mean_accel.x, a.mean_accels_030, label = 'e = 0.30')
ax1.plot(a.mean_accel.x, a.mean_accels_045, label = 'e = 0.45')
ax1.plot(a.mean_accel.x, a.mean_accels_060, label = 'e = 0.60')
ax1.plot(a.mean_accel.x, a.mean_accels_070, label = 'e = 0.70')
ax1.legend()
...
e.plot_keg_time(e.E000, e.E015, e.E030, e.E045, e.E060, e.E070, savefig=savefig, savepath=savepath)
e.plot_FrSc_time(e.E000, e.E015, e.E030, e.E045, e.E060, e.E070, savefig=savefig, savepath=savepath)
e.plot_floor_time(e.E000, e.E015, e.E030, e.E045, e.E060, e.E070, savefig=savefig, savepath=savepath)
e.plot_struts_time(e.E000, e.E015, e.E030, e.E045, e.E060, e.E070, savefig=savefig, savepath=savepath)
e.plot_stiff_skin_time(e.E000, e.E015, e.E030, e.E045, e.E060, e.E070, savefig=savefig, savepath=savepath)
